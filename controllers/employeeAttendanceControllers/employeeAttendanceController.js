...
const addEmployeeAttendance = async (req, res) => {
  ...
  const getAttendanceById = async (req, res) => {
    try {
      ...
      const getEmployeeAttendance = await employeeAttendanceService.getEmployeeAttendanceById(AttendanceId);
  ...
  const getAttendanceByIdEmployee = async (req, res) => {
    try {
      ...
      const getAttendanceByIdEmployee = await employeeAttendanceService.getAttendanceByIdEmployee(id_employee);
  ...
  const getAttendanceByIdCompany = async (req, res) => {
    try {
      ...
      const getAttendanceByIdCompany = await employeeAttendanceService.getAttendanceByIdCompany(id_company);
  ...
  const updateEmployeeAttendance = async (req, res) => {
    try {
     ...
     const updatedAttendance = await employeeAttendanceService.updateEmployeeAttendance(employeeAttendanceId,{
        pickUpStation,
        timePickUp,
        datePickUp,
        tripReference,
  ...
  const deleteEmployeeAttendance = async (req, res) => {
    try {
      ...
      const deletedemployeeAttendance = await employeeAttendanceService.deleteEmployeeAttendance(employeeAttendanceId);
  ...
  module.exports = { addEmployeeAttendance, getAttendanceById, getAttendanceByIdEmployee, getAttendanceByIdCompany, updateEmployeeAttendance, deleteEmployeeAttendance  }