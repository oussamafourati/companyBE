...
const addStudentAttendance = async (req, res) => {
  ...
  const getAttendanceById = async (req, res) => {
    try {
      ...
      const getstudentAttendance = await studentAttendanceService.getStudentAttendanceById(AttendanceId);
  ...
  const getAttendanceByIdStudent = async (req, res) => {
    try {
      ...
      const getAttendanceByIdstudent = await studentAttendanceService.getAttendanceByIdStudent(id_student);
  ...
  const getAttendanceByIdSchool = async (req, res) => {
    try {
      ...
      const getAttendanceByIdCompany = await studentAttendanceService.getAttendanceByIdSchool(id_company);
  ...
  const updateStudentAttendance = async (req, res) => {
    try {
     ...
     const updatedAttendance = await studentAttendanceService.updateStudentAttendance(studentAttendanceId,{
        pickUpStation,
        timePickUp,
        datePickUp,
        tripReference,
  ...
  const deleteStudentAttendance = async (req, res) => {
    try {
      ...
      const deletedstudentAttendance = await studentAttendanceService.deleteStudentAttendance(studentAttendanceId);
  ...
  module.exports = { addStudentAttendance, getAttendanceById, getAttendanceByIdStudent, getAttendanceByIdSchool, updateStudentAttendance, deleteStudentAttendance  }