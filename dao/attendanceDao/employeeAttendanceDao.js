...
const updateEmployeeAttendance = async (id, updateData) => {
    return await employeeAttendance.findByIdAndUpdate(id, updateData, { new: true });
};
...
module.exports = {
    addEmployeeAttendance,getAttendanceByIdCompany,getemployeeAttendanceById, getAttendanceByIdEmployee, updateEmployeeAttendance, deleteEmployeeAttendance
