...
const updateStudentAttendance = async (id, updateData) => {
    return await studentAttendance.findByIdAndUpdate(id, updateData, { new: true });
};
...
module.exports = {
    addStudentAttendance,getAttendanceByIdSchool,getStudentAttendanceById, getAttendanceByIdStudent, updateStudentAttendance, deleteStudentAttendance
