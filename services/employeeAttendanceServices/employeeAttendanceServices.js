...
const updateEmployeeAttendance = async (id, updateData) => {
 ...
 module.exports ={addEmployeeAttendance, updateEmployeeAttendance, getAttendanceByIdCompany,getEmployeeAttendanceById,getAttendanceByIdEmployee,deleteEmployeeAttendance}