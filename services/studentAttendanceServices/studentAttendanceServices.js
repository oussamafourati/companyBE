...
const updateStudentAttendance = async (id, updateData) => {
 ...
 module.exports ={addStudentAttendance, updateStudentAttendance, getAttendanceByIdSchool,getStudentAttendanceById,getAttendanceByIdStudent,deleteStudentAttendance}